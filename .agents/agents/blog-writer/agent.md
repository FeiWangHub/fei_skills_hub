...
id: blog-writer
name: Blog Writer
description: Writes engaging technical blog posts and tutorials with a professional-but-human voice, real experiences, and honest failure stories. Use when drafting blog posts, tutorials, or dev write-ups.
