...
supported. The producing scorer fixes it, or the submission goes to human review.
...
`judge-requests/<id>.md`, and does the cited `line_or_range` exist within it? A
citation to a file or line that is not in the bundle is fabricated.
...
- **Direction check** — a submission with no tests and no documentation scoring 5
  on D3 deserves scrutiny.
